    ...
    <div>
      {sorted.length === 0 ? (
        ...
        <div className="bg-surface rounded-lg border border-border overflow-x-auto">
          ...
          {/* Header */}
          <div className="grid grid-cols-[2rem_minmax(10rem,14rem)_2.25rem_2.25rem_2.25rem_2.25rem_3rem_4rem] gap-2 px-3 py-2 bg-surface-inset border-b border-border text-xs text-text-muted uppercase tracking-wide">
            ...
            return (
              <div key={member.id}>
                ...
                <button
                  ...
                  className={`w-full grid grid-cols-[2rem_minmax(10rem,14rem)_2.25rem_2.25rem_2.25rem_2.25rem_3rem_4rem] gap-2 px-3 py-2.5 border-b border-border-subtle text-left transition-colors ${
                  ...
                  <div className="px-4 py-3 bg-surface-inset/20 border-b border-border-subtle">
                    ...
                    <div className="overflow-x-auto">
                      <div className="min-w-[58rem]">
                        <div className="grid grid-cols-[minmax(8rem,11rem)_minmax(28rem,auto)_2.5rem_2.25rem_2.25rem_2.25rem_2.25rem_3.5rem] gap-2 px-2 py-1.5 text-xs text-text-muted uppercase tracking-wide border-b border-border">
                          <span>Golfer</span>
                          <span>Holes</span>
                        ...
                        {breakdown.counting.map(p => (
                          <div key={p.id} className="grid grid-cols-[minmax(8rem,11rem)_minmax(28rem,auto)_2.5rem_2.25rem_2.25rem_2.25rem_2.25rem_3.5rem] gap-2 px-2 py-1.5 items-center border-b border-border-subtle">
                        ...
                        {breakdown.dropped.map(p => (
                          <div key={p.id} className="grid grid-cols-[minmax(8rem,11rem)_minmax(28rem,auto)_2.5rem_2.25rem_2.25rem_2.25rem_2.25rem_3.5rem] gap-2 px-2 py-1.5 items-center border-b border-border-subtle opacity-50">
