                  ...
                  <div className="px-4 py-3 bg-surface-inset/20 border-b border-border-subtle">
                    ...
                    <div className="overflow-x-auto">
                      <div className="min-w-[62rem]">
                        <div className="grid grid-cols-[minmax(11rem,15rem)_minmax(28rem,auto)_2.5rem_2.25rem_2.25rem_2.25rem_2.25rem_3.5rem] gap-x-4 px-2 py-1.5 text-xs text-text-muted uppercase tracking-wide border-b border-border">
                          <span>Golfer</span>
                          <span>Holes</span>
                        ...
                        {breakdown.counting.map(p => (
                          <div key={p.id} className="grid grid-cols-[minmax(11rem,15rem)_minmax(28rem,auto)_2.5rem_2.25rem_2.25rem_2.25rem_2.25rem_3.5rem] gap-x-4 px-2 py-1.5 items-center border-b border-border-subtle">
                        ...
                        {breakdown.dropped.map(p => (
                          <div key={p.id} className="grid grid-cols-[minmax(11rem,15rem)_minmax(28rem,auto)_2.5rem_2.25rem_2.25rem_2.25rem_2.25rem_3.5rem] gap-x-4 px-2 py-1.5 items-center border-b border-border-subtle opacity-50">
