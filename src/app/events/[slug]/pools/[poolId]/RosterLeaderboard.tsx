                ...
                {isExpanded && breakdown && (
                  <div className="bg-surface-inset/20 border-b border-border-subtle">
                    ...
                    {breakdown.counting.map(p => (
                      <div key={p.id}>
                        <div className="grid grid-cols-[2rem_minmax(9rem,14rem)_1fr_2.25rem_2.25rem_2.25rem_2.25rem_3rem_4rem] gap-2 px-3 py-1.5 items-center border-b border-border-subtle">
