...
export function BracketGameCard({
    ...
    return (
      <button
        ...
        className={`
          ...
          ${isPicked && !isFinal ? 'bg-brand/15 text-brand' : ''}
  ...
  return (
    ...
    >
      ...
      <TeamRow participant={participant1} score={score1} slot={1} />
      <TeamRow participant={participant2} score={score2} slot={2} />
