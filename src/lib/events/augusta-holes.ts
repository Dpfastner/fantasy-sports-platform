...
// (0-100 on both axes). Updated after reading the image file to match the
// visible yellow flag pin positions. Nudge individual holes here if they
// still drift on screen — no component changes required.
