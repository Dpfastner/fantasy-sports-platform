...
const STANDARD_VALUES: ScoringPresetValues = {
  ...
  points_conference_championship_win: 3,
  points_conference_championship_loss: 0,
  points_heisman_winner: 5,
  points_bowl_appearance: 2,
  points_playoff_first_round: 2,
  points_playoff_quarterfinal: 3,
  points_playoff_semifinal: 4,
  points_championship_win: 6,
  points_championship_loss: 0,
}

const CONSERVATIVE_VALUES: ScoringPresetValues = {
  points_win: 1,
  points_conference_game: 0.5,
  points_over_50: 0.5,
  points_shutout: 0.5,
  points_ranked_25: 1,
  points_ranked_10: 1.5,
  points_loss: 0,
  points_conference_game_loss: 0,
  points_over_50_loss: 0,
  points_shutout_loss: 0,
  points_ranked_25_loss: 0,
  points_ranked_10_loss: 0,
  points_conference_championship_win: 2,
  points_conference_championship_loss: 0,
  points_heisman_winner: 3,
  points_bowl_appearance: 1,
  points_playoff_first_round: 1,
  points_playoff_quarterfinal: 2,
  points_playoff_semifinal: 3,
  points_championship_win: 4,
  points_championship_loss: 0,
}
...
const AGGRESSIVE_VALUES: ScoringPresetValues = {
  ...
  points_conference_championship_loss: -1,
  points_heisman_winner: 7,
  points_bowl_appearance: 3,
  points_playoff_first_round: 3,
  points_playoff_quarterfinal: 4,
  points_playoff_semifinal: 5,
  points_championship_win: 8,
  points_championship_loss: -2,
}
...
const CHAOS_VALUES: ScoringPresetValues = {
  ...
  points_conference_championship_win: 6,
  points_conference_championship_loss: -2,
  points_heisman_winner: 10,
  points_bowl_appearance: 3,
  points_playoff_first_round: 4,
  points_playoff_quarterfinal: 5,
  points_playoff_semifinal: 7,
  points_championship_win: 10,
  points_championship_loss: -3,
}
