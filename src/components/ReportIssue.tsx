...
export default function ReportIssue() {
  ...
  return (
    <>
      {/* Trigger button — positioned inline in footer row */}
      <button
        onClick={() => setIsOpen(true)}
        className="report-issue-trigger flex items-center gap-1.5 text-text-muted hover:text-text-primary transition-colors"
